...
>>>>>>> 4c79b451e68cb51989daa88b575981ae4ea874bf
...
2. **Visualizar Episodios:** La tabla izquierda lista todos los capítulos ordenados con su código identificador (`S01E01`, `S01E02`...), su título limpio, su estado actual y el progreso.
3. **Iniciar las Descargas:**
...
He publicado este software como **código abierto** y libre de modificaciones bajo propósitos educativos, de investigación y para la preservación personal de contenido de televisión pública. Te invito a examinar el código de mi script en [downloader.py](file:///c:/Users/fermi/.gemini/antigravity/scratch/merli_downloader/downloader.py) para comprender cómo implementé la concurrencia y el diseño gráfico en Python.
=======
