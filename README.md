...
4. En Windows (Recomendado): Simplemente haz doble clic en el archivo lanzador que creé: [run.bat](file:///c:/Users/fermi/.gemini/antigravity/scratch/merli_downloader/run.bat). Este iniciará la consola, llamará al script de Python y mantendrá la ventana abierta si ocurre algún error.
